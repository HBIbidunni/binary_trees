...
### Project requirement :toolbox: :old_key: :ballot_box_with_check:
...
__binary_trees.h__: Header file containing definitions and prototypes for all types and functions written for the project.
